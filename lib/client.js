...
(function() {
  var Firebase, exports, extend, fetch, isNode, request,
    slice = [].slice,
    extend1 = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
    hasProp = {}.hasOwnProperty;

  isNode = function() {
    var env_process_type, expected_process_type, process_obj;
    process_obj = typeof process !== 'undefined' ? process : 0;
    expected_process_type = '[object process]';
    env_process_type = Object.prototype.toString.call(process_obj);
    return env_process_type === expected_process_type;
  };
